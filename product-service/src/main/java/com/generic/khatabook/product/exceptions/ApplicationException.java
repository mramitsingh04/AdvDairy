...
public class ApplicationException extends RuntimeException {
    ...
    public ApplicationException(final AppEntity appEntity, SubEntity entity, final String msg) {
        super(appEntity.getName() + "." + entity.getName() + " " + msg);
    }

    public ApplicationException(final AppEntity appEntity, final Long id) {
        this(appEntity, String.valueOf(id));
    }

    public ApplicationException(final AppEntity appEntity, final String id) {
        super(appEntity.getName() + " " + id + " not fount!.");
    }

    public ApplicationException(final AppEntity khatabook, final AppEntity customer, final String khatabookId,
